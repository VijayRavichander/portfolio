...
export default function Home() {
  return (
    <main className="">
      <section
        className="h-full w-full bg-neutral-950 rounded-md 
      ...
      >
        ...
        <div className="mt-[100px] z-10 px-4">
          <div className="my-1">
            ...
            <div>
              <div className="flex my-4">
                ...
                <div className="hover:text-green-300 px-2">
                  <a href="https://drive.google.com/file/d/1aOrajvGS9YdZER8eKnQLKtvqPW7nFRTu/view?usp=sharing">
        ...
        <div className="relative w-full mt-96 md:mt-56">
        <LampContainer>
          <motion.h1
            ...
            className="mt-48 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
          >
            <div>
              <div className="text-5xl py-6">Tech Stack</div>
              <div className="">
                <div className="text-lg">
                  {techStack.map((item, index) => (
                    <div key={index} className="my-4">
                      <div className="text-3xl text-violet-300 font-bold">
                        {item.category}
                      </div>
